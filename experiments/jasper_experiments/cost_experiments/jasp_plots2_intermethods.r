...
experiments_type = c('plasticoding_seasons', 'costplasticoding')
experiments_labels = c( 'costplasticoding', 'baseline')
runs = list(c(1:6),
            c(1:6))
...
methods_labels = c('baseline plane', 'baseline tilted5', 'plastic plane', 'plastic tilted5')
